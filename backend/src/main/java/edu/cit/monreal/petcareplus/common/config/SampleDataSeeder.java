package edu.cit.monreal.petcareplus.common.config;
...
public class SampleDataSeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        List<edu.cit.monreal.petcareplus.features.services.model.Service> existing = serviceRepository.findByProviderId(provider.getProviderId());
        Set<String> existingNames = new HashSet<>();
        for (edu.cit.monreal.petcareplus.features.services.model.Service s : existing) {
    ...
    private void seedServiceIfMissing(
        ...
        edu.cit.monreal.petcareplus.features.services.model.Service service = edu.cit.monreal.petcareplus.features.services.model.Service.builder()
                .provider(provider)
                .category(category)
                .name(name)
