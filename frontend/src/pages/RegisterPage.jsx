            ...
            <form onSubmit={handleSubmit}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                <div>
                  ...
                  <input value={firstName} onChange={(e) => setFirstName(e.target.value)} placeholder="First Name" style={{ width: '100%', padding: '0.75rem', borderRadius: 0, border: '1px solid #ddd', background: '#fff', color: '#000' }} />
                ...
                <div>
                  ...
                  <input value={lastName} onChange={(e) => setLastName(e.target.value)} placeholder="Last Name" style={{ width: '100%', padding: '0.75rem', borderRadius: 0, border: '1px solid #ddd', background: '#fff', color: '#000' }} />
              ...
              <div style={{ marginTop: '0.75rem' }}>
                ...
                <input value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@example.com" style={{ width: '100%', padding: '0.75rem', borderRadius: 0, border: '1px solid #ddd', background: '#fff', color: '#000' }} />
              ...
              <div style={{ marginTop: '0.75rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.75rem' }}>
                  <button type="button" onClick={() => setRole('PET_OWNER')} style={{ flex: 1, padding: '0.75rem', borderRadius: 0, background: role === 'PET_OWNER' ? '#4CAF50' : '#fff', color: role === 'PET_OWNER' ? '#fff' : '#000', border: '1px solid #4CAF50' }}>Pet Owner</button>
                  <button type="button" onClick={() => setRole('SERVICE_PROVIDER')} style={{ flex: 1, padding: '0.75rem', borderRadius: 0, background: role === 'SERVICE_PROVIDER' ? '#4CAF50' : '#fff', color: role === 'SERVICE_PROVIDER' ? '#fff' : '#000', border: '1px solid #4CAF50' }}>Service Provider</button>
                </div>
              </div>
              <button type="submit" disabled={isSubmitting} style={{ marginTop: '1rem', width: '100%', padding: '0.9rem', borderRadius: 0, background: isSubmitting ? '#A5D6A7' : '#4CAF50', color: '#fff', border: 'none', fontWeight: 600, cursor: isSubmitting ? 'not-allowed' : 'pointer' }}>
